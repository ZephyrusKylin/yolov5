...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5m_us.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/dota_add_v2.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--project', default=OUT_DIR / 'runs/train', help='save to project/name')
